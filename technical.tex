...
Once the onboarding form is complete, you will be contacted by IT and will be handed out your Domain account credentials completing the onboarding process. The credentials give you access to services such as Jira, Confluence, Docushare, Exchange and most importantly the Rubin Observatory WIFI network called "LSST-WAP" that can be found both at Cerro Pachon and La Serena Base facility.
...
\subsection{How to connect to the WIFI Network using a laptop computer}
