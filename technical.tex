...
\begin{figure}
  \includegraphics[width=16cm]{Images/Android1.jpg}
  \caption*{Select the LSST WAP WIFI Network}

  \includegraphics[width=16cm]{Images/Android2.jpg}
  \caption*{Fill out the fields highlighted in red as instructed and hit connect}
  \includegraphics[width=16cm]{Images/Android3.jpg}
  \includegraphics[width=16cm]{Images/Android4.jpg}
\end{figure}

\subsubsection{Apple}

\begin{figure}
  \includegraphics[width=16cm]{Images/ios1.png}
  \caption*{Select the LSST WAP WIFI Network}

  \includegraphics[width=16cm]{Images/ios2.png}
  \caption*{Log in with your Domain account credentials}

  \includegraphics[width=16cm]{Images/ios3.png}
...
\begin{figure}
  \includegraphics[width=16cm]{Images/Mac1.png}
  \caption*{Select the LSST WAP WIFI Network}

  \includegraphics[width=16cm]{Images/Mac2.png}
  \caption*{Log in with your Domain account credentials}

  \includegraphics[width=16cm]{Images/Mac3.png}
  \caption*{Select OK once your username and password is filled out}

  \includegraphics[width=16cm]{Images/Mac4.png}
  \caption*{Accept the certificate}
\end{figure}
