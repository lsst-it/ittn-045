...
If you are not, you need to be invited in the rubin-summit organisation and added to the rsp-access team. Ask on the \verbatim{#com-square} Slack channel to be added to summit-access, mention your Github username and a number of people will be able to add you.

Note: Adding your Github username to your Slack profile is really helpful and saves you from being asked to supply it. To do that, Edit Profile on Slack and sroll down until you find a field called Github Username.
