...
\subsection{Add Public Key Into IPA}
...
The current list of temporary accounts is available at \href{https://rubinobs.atlassian.net/l/cp/ddeM4LkA}{https://rubinobs.atlassian.net/l/cp/ddeM4LkA}, where managers should also record any overrides.
