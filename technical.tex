...
\newpage
  ...
  \begin{figure}
    ...
    \caption*{Accept the certificate and select trust to connect to the WIFI network}
  \end{figure}
...
\newpage
  ...
  \begin{figure}
    ...
    \begin{subfigure}{0.40\textwidth}
      ...
      \caption*{Select the LSST WAP SSID from the list}
    \end{subfigure}
    \centering
    \begin{subfigure}{0.40\textwidth}
      \includegraphics[width=\textwidth]{Images/Mac2.png}
      \caption*{Log in with your domain account credentials}
    \end{subfigure}
  \end{figure}
