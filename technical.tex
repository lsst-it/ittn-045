...
Once the onboarding form is complete and the AUP form is submitted, IT will contact you to hand out your Domain account credentials concluding the onboarding process. These credentials depending on the level of access requested by the manager will give you access to services such as Jira, Confluence, Docushare, Exchange and most importantly the Rubin Observatory WIFI network named "LSST-WAP", this WIFI SSID can be found both at Cerro Pachon and La Serena Base facility.
  ...
  \subsection{Connecting to the WIFI Network using a mobile device}

    \subsubsection{Android}
        \begin{figure}
          \includegraphics[width=10cm]{Images/Android1.jpg}
          \caption*{Select the LSST WAP WIFI Network}
          \includegraphics[width=10cm]{Images/Android2.jpg}
          \caption*{Fill out the fields highlighted in red as instructed and hit connect}
          \includegraphics[width=10cm]{Images/Android3.jpg}
          \includegraphics[width=10cm]{Images/Android4.jpg}
        \end{figure}
\newpage
    \subsubsection{Apple}

      \begin{figure}
        \includegraphics[width=10cm]{Images/ios1.png}
        \caption*{Select the LSST WAP WIFI Network}
        \includegraphics[width=10cm]{Images/ios2.png}
        \caption*{Log in with your Domain account credentials}
        \includegraphics[width=10cm]{Images/ios3.png}
        \caption*{Accept the certificate}
      \end{figure}

  \subsection{Connecting to the WIFI Network using a laptop computer}
    ...
    \subsubsection{Mac OS}
      ...
      \begin{figure}
        \includegraphics[width=10cm]{Images/Mac1.png}
        \caption*{Select the LSST WAP WIFI Network}
        
        \includegraphics[width=10cm]{Images/Mac2.png}
        \caption*{Log in with your Domain account credentials}

        \includegraphics[width=10cm]{Images/Mac3.png}
        \caption*{Select OK once your username and password is filled out}

        \includegraphics[width=10cm]{Images/Mac4.png}
        \caption*{Accept the certificate}
      \end{figure}
    \subsubsection{linux}

      \begin{figure}
        \includegraphics[width=16cm]{Images/Linux.png}
        \caption{Fill out the information as followed, and log in with your Domain Account credentials.}
      \end{figure}
