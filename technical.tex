...
\newpage
  ...
  \begin{figure}
    ...
    \begin{subfigure}{0.30\textwidth}
      ...
      \centering
      3.) Accept the certificate and hit on the trust button. 
    \end{subfigure}
  \end{figure} 
...
\newpage
  ...
  \begin{figure}
    ...
    \begin{subfigure}{0.35\textwidth}
      ...
      \centering
      2.) Select connect, log in with your domain account credentials both username and password and accept the certificate if prompted.
    \end{subfigure}
  \end{figure}
